<x-layout :title="$title">
                ...
                <div class=" mx-auto gap-6">
                    <div class="w-3/4 h-fit p-5 mx-auto bg-slate-50 rounded-xl">
                        ...
                        <div class="space-y-4 mx-auto">
                            <form action="/dashboard/{{ $dataBuku->slug }}" method="POST" enctype="multipart/form-data">
                                @method('patch')
                                @csrf
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="judul" name="judul"
                                                ...
                                                required autofocus value="{{ old('judul', $dataBuku->judul) }}">
                                            @error('judul')
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="pembuat" name="pembuat"
                                                value="{{ old('pembuat', $dataBuku->pembuat) }}"
                                                class="mt-1 block w-full h-10 rounded-md border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2 px-4 text-lg"
                                                required>
                                            @error('pembuat')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="mt-2">Foto Saat ini :</p>
                                                <img src="{{ asset('storage/' . $dataBuku->cover) }}" alt="Cover Buku"
                                                    class="mt-2 w-lg">
                                            @else
                                                <p class="font-medium text-sm text-red-600">*Data buku tidak memiliki cover</p>
                                            @endif
                                            @error('cover')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="deskripsi" name="deskripsi"
                                                ...
                                                required oninput="resizeTextarea(this)">{{ old('deskripsi', $dataBuku->deskripsi) }}</textarea>
                                            @error('deskripsi')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="penerbit" name="penerbit"
                                                value="{{ old('penerbit', $dataBuku->penerbit) }}"
                                                class="mt-1 block w-full h-10 rounded-md border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2 px-4 text-lg"
                                                required>
                                            @error('penerbit')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="number" id="halaman" name="halaman"
                                                value="{{ old('halaman', $dataBuku->halaman) }}"
                                                class="mt-1 block w-full h-10 rounded-md border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2 px-4 text-lg"
                                                required min="1">
                                            @error('halaman')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="bahasa" name="bahasa"
                                                value="{{ old('bahasa', $dataBuku->bahasa) }}"
                                                class="mt-1 block w-full h-10 rounded-md border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm py-2 px-4 text-lg"
                                                required>
                                            @error('bahasa')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            ...
                                            <select id="category_id" name="category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ old('category_id', $dataBuku->category_id) == $category->id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
    ...
    <script>
        ...
        // Jalankan fungsi ini saat halaman dimuat agar textarea langsung menyesuaikan tinggi
        document.addEventListener("DOMContentLoaded", function() {
            resizeTextarea(document.getElementById("deskripsi"));
        });
    </script>
</x-layout>
